/*
This release is for CMS v4
  Todo: 
  alert with the fields that were not updated

  this is an adaptation of Coder Swartz redirect bookmarklet to update SEO values 
*/
/* global $ */
var AutoSEO = {
  version: "1.2.1",
  ...
  init: function() {
    ...
    this.titles = $("tr td:nth-child(2) .seo-title textarea", this.pageContainers);
    this.descriptions = $("td:nth-child(3) .seo-description textarea", this.pageContainers);
  ...
  clearTitleDescriptionButtonEvent: function() {
    this.clearTitleDescriptionButton.click(function(e) {
      ...
      $(this.titles).val("").focus();
      $(this.descriptions).val("").focus();
